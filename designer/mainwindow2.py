...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_sliders.setGeometry(QtCore.QRect(320, 870, 651, 31))
        self.frame_sliders.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_sliders.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_sliders.setObjectName("frame_sliders")
        self.horizontalSlider_f = QtWidgets.QSlider(self.frame_sliders)
        self.horizontalSlider_f.setGeometry(QtCore.QRect(0, 10, 631, 22))
        self.horizontalSlider_f.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_f.setObjectName("horizontalSlider_f")
        self.horizontalSlider_w = QtWidgets.QSlider(self.frame_sliders)
        self.horizontalSlider_w.setGeometry(QtCore.QRect(0, 10, 631, 22))
        self.horizontalSlider_w.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_w.setObjectName("horizontalSlider_w")
        self.horizontalSlider_T = QtWidgets.QSlider(self.frame_sliders)
        self.horizontalSlider_T.setGeometry(QtCore.QRect(0, 10, 631, 22))
        self.horizontalSlider_T.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_T.setObjectName("horizontalSlider_T")
        self.horizontalSlider_A = QtWidgets.QSlider(self.frame_sliders)
        self.horizontalSlider_A.setGeometry(QtCore.QRect(0, 10, 631, 22))
        self.horizontalSlider_A.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_A.setObjectName("horizontalSlider_A")
        self.horizontalSlider_psy = QtWidgets.QSlider(self.frame_sliders)
        self.horizontalSlider_psy.setGeometry(QtCore.QRect(0, 10, 631, 22))
        ...
        self.horizontalSlider_KG = QtWidgets.QSlider(self.frame_sliders)
        self.horizontalSlider_KG.setGeometry(QtCore.QRect(0, 10, 631, 22))
